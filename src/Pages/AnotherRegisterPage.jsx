...
export default function AnotherRegisterPage() {

    const [loading, setLoading] = useState(false);
    const [open, setOpen] = useState(false);
    const [message, setMessage] = useState('Registered Successfully!');
  ...
  return (
    <div class="max-w-lg mx-auto  bg-white dark:bg-gray-800 rounded-lg shadow-md px-8 py-10 flex flex-col items-center">
      ...
      <form  onSubmit={createAccount} class="w-full flex flex-col gap-4">
